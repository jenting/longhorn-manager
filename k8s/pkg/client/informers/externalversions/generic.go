...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1beta1.SchemeGroupVersion.WithResource("backupstorebackupvolumes"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Longhorn().V1beta1().BackupStoreBackupVolumes().Informer()}, nil
