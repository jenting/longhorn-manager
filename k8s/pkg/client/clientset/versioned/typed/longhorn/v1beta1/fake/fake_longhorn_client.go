...
func (c *FakeLonghornV1beta1) BackupStoreBackupVolumes(namespace string) v1beta1.BackupStoreBackupVolumeInterface {
	return &FakeBackupStoreBackupVolumes{c, namespace}
}
