...
func (c *FakeLonghornV1beta1) BackupStoreVolumeBackups(namespace string) v1beta1.BackupStoreVolumeBackupInterface {
	return &FakeBackupStoreVolumeBackups{c, namespace}
}
